    ...
    # Check if WAN is Enabled
      ...
      if [[ "${WANPREFIX}" == "$(echo $WANPREFIXES | awk '{print $1}')" ]] >/dev/null;then
        ...
        # Check WAN0 IP Address Target Route
          ...
          ip route add $WAN0TARGET via $(nvram get ${WANPREFIX}_gateway) dev $(nvram get ${WANPREFIX}_gw_ifname) metric 1
      ...
      # Check WAN1 Connection
        ...
        # Check WAN1 IP Address Target Route
          ...
          ip route add $WAN1TARGET via $(nvram get ${WANPREFIX}_gateway) dev $(nvram get ${WANPREFIX}_gw_ifname) metric 1
