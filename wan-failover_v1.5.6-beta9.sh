...
while \
  ...
  && [[ "$(ping -I $(nvram get wan0_gw_ifname) $WAN0TARGET -c $PINGCOUNT -W $PINGTIMEOUT -s $PACKETSIZE | grep -e "packet loss" | awk '{print $7}')" == "0%" ]] \
  ...
  && [[ "$(ping -I $(nvram get wan1_gw_ifname) $WAN1TARGET -c $PINGCOUNT -W $PINGTIMEOUT -s $PACKETSIZE | grep -e "packet loss" | awk '{print $7}')" == "0%" ]] \
